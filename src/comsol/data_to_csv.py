...
def add_bd_data(csv_path):
    ...
    # 保存结果
    df.to_csv("exports/slit-5-28/params_updated.csv", index=False)


if __name__ == "__main__":
    # merge_params_to_csv("exports/slit-5-28/cfg")
    # add_bd_path("exports/slit-5-28/params.csv")
    add_bd_data("exports/slit-5-28/params.csv")
    pass